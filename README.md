Simple application based on my database for Rent A Car Agency in C#. I used Entity Framework to connect to database (Database First approach) and LINQ to get the specific data from it.
